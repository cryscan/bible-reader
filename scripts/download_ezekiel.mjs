...
const TOTAL = parseInt(process.argv[2] || '48', 10)
...
async function main() {
  ...
  fs.writeFileSync('src/data/ezekiel_raw.json', JSON.stringify(out, null, 2), 'utf-8')
  console.log(`\n完成！共 ${chapters.length} 章，已写入 src/data/ezekiel_raw.json`)
}
